...
const char* grin_get_static_storage_feature_msg() {
...
#endif
           trait->add_vertex_list_retrievals(
...
#endif
                  trait->add_edge_list_retrievals(
                      grin::ListRetrieval::LR_ARRAY_LIKE);
#endif
...
#endif
           trait->add_adjacent_list_retrievals(
               grin::ListRetrieval::LR_ARRAY_LIKE);
#endif
...

  {
    ...
    trait->set_graph_partition_strategy(
