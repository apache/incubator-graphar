...
PROTOBUF_CONSTEXPR PartitionFeature::PartitionFeature(
  ...
  , /*decltype(_impl_.grin_trait_fast_vertex_ref_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_graph_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::grin::PartitionFeature, _impl_.grin_trait_fast_vertex_ref_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 45, -1, -1, sizeof(::grin::VertexPropertyFeature)},
  { 59, -1, -1, sizeof(::grin::EdgePropertyFeature)},
  { 72, -1, -1, sizeof(::grin::PropertyFeature)},
  { 90, -1, -1, sizeof(::grin::IndexFeature)},
  { 99, -1, -1, sizeof(::grin::PredicateFeature)},
  { 105, -1, -1, sizeof(::grin::StorageFeature)},
  { 117, -1, -1, sizeof(::grin::Statistics)},
  { 128, -1, -1, sizeof(::grin::Graph)},
};
...
const ::_pbi::DescriptorTable descriptor_table_graph_2eproto = {
    false, false, 3740, descriptor_table_protodef_graph_2eproto,
    "graph.proto",
...
PartitionFeature::PartitionFeature(const PartitionFeature& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.grin_trait_fast_vertex_ref_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.graph_partition_strategy_, &from._impl_.graph_partition_strategy_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.grin_trait_fast_vertex_ref_) -
    reinterpret_cast<char*>(&_impl_.graph_partition_strategy_)) + sizeof(_impl_.grin_trait_fast_vertex_ref_));
...
// @@protoc_insertion_point(message_clear_start:grin.PartitionFeature)
  ...
  ::memset(&_impl_.graph_partition_strategy_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.grin_trait_fast_vertex_ref_) -
      reinterpret_cast<char*>(&_impl_.graph_partition_strategy_)) + sizeof(_impl_.grin_trait_fast_vertex_ref_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          _impl_.grin_trait_fast_vertex_ref_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PartitionFeature::_InternalSerialize(
  ...
  // bool grin_trait_fast_vertex_ref = 14;
  if (this->_internal_grin_trait_fast_vertex_ref() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(14, this->_internal_grin_trait_fast_vertex_ref(), target);
  }
...
void PartitionFeature::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_grin_trait_fast_vertex_ref() != 0) {
    _this->_internal_set_grin_trait_fast_vertex_ref(from._internal_grin_trait_fast_vertex_ref());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void PartitionFeature::InternalSwap(PartitionFeature* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PartitionFeature, _impl_.grin_trait_fast_vertex_ref_)
      + sizeof(PartitionFeature::_impl_.grin_trait_fast_vertex_ref_)
