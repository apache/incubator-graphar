...
void vertices_collection(const std::shared_ptr<GAR_NAMESPACE::GraphInfo>& graph_info) {
...
void edges_collection(const std::shared_ptr<GAR_NAMESPACE::GraphInfo>& graph_info) {
