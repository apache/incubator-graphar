...
VertexPropertyArrowChunkReader::VertexPropertyArrowChunkReader(const std::shared_ptr<VertexInfo>& vertex_info,
...
Result<std::shared_ptr<VertexPropertyArrowChunkReader>> VertexPropertyArrowChunkReader::Make(
...
AdjListArrowChunkReader::AdjListArrowChunkReader(const std::shared_ptr<EdgeInfo>& edge_info, AdjListType adj_list_type,
                          const std::string& prefix,
...
AdjListArrowChunkReader::AdjListArrowChunkReader(const AdjListArrowChunkReader& other)
...
AdjListArrowChunkReader::GetChunk() {
  ...
  Status AdjListArrowChunkReader::seek_chunk_index(IdType vertex_chunk_index, IdType chunk_index) {
...
Result<std::shared_ptr<AdjListArrowChunkReader>> AdjListArrowChunkReader::Make(
      ...
      if (!edge_info) {
          return Status::KeyError("The edge ", src_type, " ", edge_type, " ", dst_type, " doesn't exist.");
      }
    return Make(edge_info, adj_list_type, graph_info->GetPrefix());
  }

AdjListOffsetArrowChunkReader::AdjListOffsetArrowChunkReader(const std::shared_ptr<EdgeInfo>& edge_info,
                                        AdjListType adj_list_type,
                                        const std::string& prefix)
...
Result<std::shared_ptr<AdjListOffsetArrowChunkReader>> AdjListOffsetArrowChunkReader::Make(
      const std::shared_ptr<EdgeInfo>& edge_info, AdjListType adj_list_type,
      const std::string& prefix) {
    if (!edge_info->HasAdjacentListType(adj_list_type)) {
      return Status::KeyError(
...
AdjListPropertyArrowChunkReader::AdjListPropertyArrowChunkReader(const std::shared_ptr<EdgeInfo>& edge_info,
                                  const std::shared_ptr<PropertyGroup>& property_group,
                                  AdjListType adj_list_type,
                                  const std::string prefix,
                                  IdType vertex_chunk_index ,
...
AdjListPropertyArrowChunkReader::AdjListPropertyArrowChunkReader(const AdjListPropertyArrowChunkReader& other)
      : edge_info_(other.edge_info_),
...
AdjListPropertyArrowChunkReader::GetChunk() {
  ...
  Status AdjListPropertyArrowChunkReader::seek_chunk_index(IdType vertex_chunk_index, IdType chunk_index) {
    if (vertex_chunk_index_ != vertex_chunk_index) {
      vertex_chunk_index_ = vertex_chunk_index;
      GAR_ASSIGN_OR_RAISE_ERROR(
          chunk_num_, util::GetEdgeChunkNum(prefix_, edge_info_, adj_list_type_,
...
Result<std::shared_ptr<AdjListPropertyArrowChunkReader>> AdjListPropertyArrowChunkReader::Make(
