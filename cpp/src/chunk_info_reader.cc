...
VertexPropertyChunkInfoReader::VertexPropertyChunkInfoReader(const std::shared_ptr<VertexInfo>& vertex_info,
...
Result<std::shared_ptr<VertexPropertyChunkInfoReader>> VertexPropertyChunkInfoReader::Make(const std::shared_ptr<VertexInfo>& vertex_info, const std::shared_ptr<PropertyGroup>& property_group,
      const std::string& prefix) {
    return std::make_shared<VertexPropertyChunkInfoReader>(
        vertex_info, property_group, prefix);
  }

Result<std::shared_ptr<VertexPropertyChunkInfoReader>> VertexPropertyChunkInfoReader::Make(
...
AdjListChunkInfoReader::AdjListChunkInfoReader(const std::shared_ptr<EdgeInfo>& edge_info,
...
AdjListOffsetChunkInfoReader::AdjListOffsetChunkInfoReader(const std::shared_ptr<EdgeInfo>& edge_info,
                                        AdjListType adj_list_type,
                                        const std::string& prefix)
      : edge_info_(std::move(edge_info)),
        adj_list_type_(adj_list_type),
...
Result<std::shared_ptr<AdjListOffsetChunkInfoReader>> AdjListOffsetChunkInfoReader::Make(
      const std::shared_ptr<EdgeInfo>& edge_info, AdjListType adj_list_type,
      const std::string& prefix) {
    if (!edge_info->HasAdjacentListType(adj_list_type)) {
      return Status::KeyError(
...
AdjListPropertyChunkInfoReader::AdjListPropertyChunkInfoReader(const std::shared_ptr<EdgeInfo>& edge_info,
                                          const std::shared_ptr<PropertyGroup>& property_group,
                                          AdjListType adj_list_type,
                                          const std::string prefix)
      : edge_info_(std::move(edge_info)),
...
Result<std::shared_ptr<AdjListPropertyChunkInfoReader>> AdjListPropertyChunkInfoReader::Make(
