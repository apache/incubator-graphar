...
TEST_CASE("test_vertex_property_writer_from_file") {
  ...
  IdType* ptr = reinterpret_cast<IdType*>(num->data());
...
TEST_CASE("test_edge_chunk_writer") {
  ...
  IdType* edge_num_ptr = reinterpret_cast<IdType*>(edge_num->data());
  ...
  IdType* vertex_num_ptr = reinterpret_cast<IdType*>(vertex_num->data());
