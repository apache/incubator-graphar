...
class GraphInfoSuite extends AnyFunSuite {
  ...
  test("load vertex info") {
    ...
    assert(vertex_info.getPathPrefix(property_group_2) == "vertex/person/firstName_lastName_gender/")
  ...
  test("load edge info") {
    ...
    assert(edge_info.getVerticesNumFilePath(AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/vertex_count")
    assert(edge_info.getEdgesNumFilePath(0, AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/edge_count0")
    assert(edge_info.getEdgesNumPathPrefix(AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/edge_count")
    ...
    assert(edge_info.getAdjListPathPrefix(0, AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/adj_list/part0/")
    ...
    assert(edge_info.getAdjListPathPrefix(1, AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/adj_list/part1/")
    assert(edge_info.getAdjListPathPrefix(AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/adj_list/")
    ...
    assert(edge_info.getOffsetPathPrefix(AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/offset/")
    ...
    assert(edge_info.getPropertyGroupPathPrefix(property_group, AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/creationDate/")
    ...
    assert(edge_info.getAdjListPathPrefix(0, AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/adj_list/part0/")
    ...
    assert(edge_info.getAdjListPathPrefix(1, AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/adj_list/part1/")
    assert(edge_info.getAdjListPathPrefix(AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/adj_list/")
    ...
    assert(edge_info.getOffsetPathPrefix(AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/offset/")
    ...
    assert(edge_info.getPropertyGroupPathPrefix(property_group_2, AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/creationDate/")
    ...
    assertThrows[IllegalArgumentException](edge_info.getVerticesNumFilePath(AdjListType.unordered_by_source))
    assertThrows[IllegalArgumentException](edge_info.getEdgesNumFilePath(0, AdjListType.unordered_by_source))
    assertThrows[IllegalArgumentException](edge_info.getEdgesNumPathPrefix(AdjListType.unordered_by_source))
