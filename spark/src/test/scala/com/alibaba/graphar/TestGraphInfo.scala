...
class GraphInfoSuite extends AnyFunSuite {
  ...
  test("load edge info") {
    ...
    assert(edge_info.getAdjListFilePath(0, AdjListType.ordered_by_source) == "edge/person_knows_person/ordered_by_source/adj_list/part0/")
    ...
    assert(edge_info.getAdjListFilePath(0, AdjListType.ordered_by_dest) == "edge/person_knows_person/ordered_by_dest/adj_list/part0/")
