 ...
 *
 * Support all static and dynamic entity types in LDBC SNB, including vertex and edge entities.
 * Provide unified type identification and property definitions.
 */
...
case object HasCreatorEdge extends EdgeEntityType {
 ...
 override val expectedFieldCount: Int = 2
 override val srcVertexType: VertexEntityType = PostVertex // cancanisPostorComment
 override val dstVertexType: VertexEntityType = PersonVertex
}
...
case object ReplyOfEdge extends EdgeEntityType {
 ...
 override val dstVertexType: VertexEntityType = PostVertex // cancanisPostorComment
}
