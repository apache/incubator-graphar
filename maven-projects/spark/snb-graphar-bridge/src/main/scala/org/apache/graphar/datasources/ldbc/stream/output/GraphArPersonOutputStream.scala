 ...
 *
 * extends LDBC RecordOutputStream[Person]Interface,Aligned withPersonoutputStreamfeature
 * Responsible for converting Person entity and its related relationships to GraphAr format output
 */
class GraphArPersonOutputStream(
 ...
 logger.info(s"GraphArPersonOutputStream initialized: output_path=$output_path, graph_name=$graph_name")
 ...
 */
 ...
 logger.debug(s"Added knows relationship: ${person.getAccountId} -> ${knows.to().getAccountId}")
 }
 }
 }
 ...
 */
 ...
 logger.debug(s"Added hasInterest relationship: ${person.getAccountId} -> $interestId")
 }
 }
 }
 ...
 */
 ...
 logger.debug(s"Added studyAt relationship: ${person.getAccountId} -> $universityId")
 }
 }
 ...
 */
 ...
 logger.debug(s"Added workAt relationship: ${person.getAccountId} -> $companyId")
 }
 }
 }
 ...
 */
 ...
 logger.info(s"Person data flush completed: Person=${personCount}, knows=${knowsCount}, interest=${interestCount}, studyAt=${studyAtCount}, workAt=${workAtCount}")
 ...
 */
 ...
 logger.info(s"Knows relationship write completed: ${knowsRecords.size} records")
 }
 ...
 */
 ...
 writeDataFrameToGraphAr(interestDF, s"$output_path/edge/Person_hasInterest_Tag")

 logger.info(s"HasInterest relationship write completed: ${interestRecords.size} records")
 }
 ...
 */
 ...
 writeDataFrameToGraphAr(studyAtDF, s"$output_path/edge/Person_studyAt_Organisation")

 logger.info(s"StudyAt relationship write completed: ${studyAtRecords.size} records")
 }
 ...
 */
 ...
 writeDataFrameToGraphAr(workAtDF, s"$output_path/edge/Person_workAt_Organisation")

 logger.info(s"WorkAt relationship write completed: ${workAtRecords.size} records")
 }
