...
public interface VertexInfo extends CXXPointer {
   ...
   * @return A Result object containing the PropertyGroup object, or a KeyError Status object if the
   ...
   *
   * @param propertyGroup The PropertyGroup object to add.
   * @return A Result object containing the new VertexInfo object, or a Status object indicating an
   *     error.
   */
  @FFINameAlias("Extend")
  @CXXValue
   ...
   * @return A Result object containing the path prefix, or a KeyError Status object if the property
   *     group is not found in the vertex info.
   */
