...
import static com.alibaba.graphar.util.CppClassName.GAR_EDGES_COLLECTION_UNORDERED_BY_SOURCE;
...
@FFIGen
@FFITypeAlias(GAR_EDGES_COLLECTION_UNORDERED_BY_SOURCE)
@CXXHead(GAR_GRAPH_H)
public interface EdgesCollectionUnorderedBySource extends EdgesCollection, CXXPointer {
  Factory factory = FFITypeFactory.getFactory(EdgesCollectionUnorderedBySource.class);
  ...
  interface Factory {
     ...
     */
    EdgesCollectionUnorderedBySource create(
