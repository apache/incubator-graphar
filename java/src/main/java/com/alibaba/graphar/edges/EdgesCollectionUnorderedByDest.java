...
import static com.alibaba.graphar.util.CppClassName.GAR_EDGES_COLLECTION_UNORDERED_BY_DEST;
...
@FFIGen
@FFITypeAlias(GAR_EDGES_COLLECTION_UNORDERED_BY_DEST)
@CXXHead(GAR_GRAPH_H)
public interface EdgesCollectionUnorderedByDest extends EdgesCollection, CXXPointer {
  Factory factory = FFITypeFactory.getFactory(EdgesCollectionUnorderedByDest.class);
  ...
  interface Factory {
     ...
     */
    EdgesCollectionUnorderedByDest create(
