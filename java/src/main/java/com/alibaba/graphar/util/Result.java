...
import static com.alibaba.graphar.util.CppClassName.STD_SHARED_PTR;
...
@CXXTemplate(
        ...
        java =
                "com.alibaba.graphar.stdcxx.StdSharedPtr<com.alibaba.graphar.vertices.VerticesCollection>")
@CXXTemplate(
        cxx = STD_SHARED_PTR + "<" + GAR_EDGES_COLLECTION + ">",
        java = "com.alibaba.graphar.stdcxx.StdSharedPtr<com.alibaba.graphar.edges.EdgesCollection>")
