...
import static com.alibaba.graphar.util.CppClassName.GAR_BUILDER_EDGE;
...
public interface Edge extends CXXPointer {
  ...
  @FFITypeAlias(GAR_ID_TYPE) long getSource();
  ...
  @FFITypeAlias(GAR_ID_TYPE) long getDestination();
   ...
   */
  @FFINameAlias("GetProperty") <T> @CXXReference T getProperty(@CXXReference StdString property);
   ...
   */
  @FFINameAlias("GetProperties") <T> @CXXReference StdUnorderedMap<StdString, T> getProperties();
